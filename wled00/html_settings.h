...
Volver</button><button type="submit">Guardar</button><hr><h2>Config WiFi</h2>
<h3>Conectar a tu WiFi</h3>Nombre del WiFi (SSID):<br><input name="CS" 
maxlength="32"><br>Contrasena del WiFi:<br><input type="password" name="CP" 
maxlength="63"><br>IP EstC!tica (0.0.0.0 para DHCP):<br><input name="I0" 
...
Puerta de enlace:<br><input name="G0" type="number" min="0" max="255" required>
 . <input name="G1" type="number" min="0" max="255" required> . <input 
name="G2" type="number" min="0" max="255" required> . <input name="G3" 
type="number" min="0" max="255" required><br>Mascara de red:<br><input 
name="S0" type="number" min="0" max="255" required> . <input name="S1" 
...
name="AP" maxlength="63"><br>Access Point WiFi channel: <input name="AC" 
...
name="WS" type="hidden"><br><i>Can help with connectivity issues.<br>
Do not enable if WiFi is working correctly, increases power consumption.</i><hr>
<button type="button" onclick="B()">Volver</button><button type="submit">Guardar
